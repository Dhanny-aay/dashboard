...
const register = () => {
    return ( 
        <div className=" content md:px-32 py-[70px] bg-white flex flex-row ">
            <div className=' bg-[#1b1c1e] hidden md:block h-[75vh] w-[50%] rounded-l-xl p-8 animate__animated animate__slideInUp animate__slow relative'>
            ...
            <div className=" login-container p-6 bg-[#f8f8f8] flex flex-col md:p-8 items-center w-full md:w-[50%] h-[75vh] rounded-r-xl relative animate__animated animate__slideInDown animate__slow">
