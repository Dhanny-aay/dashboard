  ...
  return (
    <div className="App bg-white p-8">
      <div className=" relative flex flex-row">
        ...
        <div className="second-row px-8 relative">
          ...
          <div className='stats p-6 bg-[#f8f8f8] rounded-2xl mt-8 shadow-sm flex flex-row'>
            <div className=''>
          ...
          <div className=' flex flex-row mt-2 justify-between'>
            <div className=' bg-[#f8f8f8] p-3 rounded-2xl shadow-sm'>
              ...
              <p className=' w-[160px] text-xs font-montserrat font-light mt-2 p-1 text-gray-600'>A prototype is an early example, model or projection of a product to test ideas until it is brought to life.</p>
            ...
            <div className=' bg-black p-3 rounded-2xl shadow-sm'>
              ...
              <p className=' w-[160px] text-xs  font-montserrat font-light mt-2 p-1 text-gray-300'>Typography is the art of arranging letters and text in a way that makesit appealing and clear to the reader.</p>
              <div className=' flex flex-row mt-2'>
                <img src={ users } className=' h-6' alt="" />
                <div className='ml-auto flex flex-row space-x-1'>
            ...
            <div className=' bg-[#f8f8f8] p-3 rounded-2xl shadow-sm'>
              <p className=' font-montserrat font-medium text-base'>Prototyping</p>
              <p className=' w-[160px] text-xs font-montserrat font-light mt-2 p-1 text-gray-600'>A prototype is an early example, model or projection of a product to test ideas until it resembles the final product.</p>
              <div className=' flex flex-row mt-2'>
                <img src={ users } className=' h-6' alt="" />
                <div className='ml-auto flex flex-row space-x-1'>
                  <img src={ clap } className='' alt="" />
        ...
        <div className=' third-row pr-8'>
          ...
          <div className=' second-col bg-[#f8f8f8] p-6 mt-8 shadow-sm rounded-2xl space-y-5'>
            <div className=' bg-white p-3 rounded-xl shadow-md flex flex-row items-center w-[32vw]'>
              <div className=' flex flex-row'>
