            ...
            className=" bg-[#f1f1f1] w-full lg:block flex flex-col justify-center items-center pb-[170px] rounded-[18px] py-5 px-8 relative">
                ...
                <div className=" w-full md:w-[350px] lg:block flex items-center flex-col">
                    <div className=" flex flex-col mt-5 w-full md:w-[350px] items-start md:items-start">
                        ...
                        <input type="text" name="name" className=" md:w-[350px] w-full p-2 rounded-md mt-1" />
                    </div>
                    ...
                    <div className=" flex flex-col mt-5 w-full md:w-[350px]">
                        ...
                        <input type="text" name="cardNumber" className=" w-full md:w-[350px] p-2 rounded-md mt-1" />
                    </div>
                    ...
                    <div className=" flex flex-row w-full md:w-[350px] justify-between mt-5">
                        <div className="flex flex-col">
                            ...
                            <input type="text" name="edate" className=" w-[90%] p-2 rounded-md mt-1" />
                        </div>
                        <div className="flex flex-col">
                            <label htmlFor="cvv" className=" text-[10px] font-montserrat text-gray-400">CVV Code</label>
                            <input type="text" name="cvv" className=" w-[100%] p-2 rounded-md mt-1" />
                        </div>
                    </div>
                    <button className=" bg-black px-5 mt-5 mr-auto rounded-2xl font-montserrat text-sm py-[10px] text-white">Submit</button>
                    <span className=" font-montserrat flex-row w-[350px] flex text-red-600 text-[10px] md:absolute mt-10 bottom-10">*Disclaimer:<p className=" text-black">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin eu dignissim erat, egestas rhoncus tellus. Nam eu erat tincidunt nibh aliquet mollis quis at.</p></span>
                </div>            
            </motion.div>
        </div>
     );
